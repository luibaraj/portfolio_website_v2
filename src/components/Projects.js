...
const Projects = () => {
    ...
    useEffect(() => {
        let newShows = [false, false, false];
        newShows[slide] = true;
        setShows(newShows);
    ...
    return (
        <div id="Proj">
            ...
            <div id="Projects" className="Proj-container">
                ...
                {shows[2] && <Project className="mySlides"  key='3' projectName="Weather App" role="front-end developer" summary="The features in this project allow you to search for the current weather of any city using the city's name. Features include the current temperture, highest and lowest recorded temp, humidity and cloudiness levels, and wind speed. This project was developed using React and was styled with css. Github was also used for version control." tech="HTML, CSS, and Javascript (React, fetch API)" link={false}/>}
            </div>
